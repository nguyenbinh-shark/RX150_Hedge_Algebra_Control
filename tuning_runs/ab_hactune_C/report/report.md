# So sánh HAC vs Fuzzy — `ab_hactune_C`
...
|---|---|---|---|---|---|---|---|
| RMSE bám [°] | 0.57 ± — | 0.967 ± 0.11 | -41 | — | — | — | HAC |
| Sai số bám lớn nhất [°] | 2.12 ± — | 4.58 ± 2.1 | -53.6 | — | — | — | HAC |
| Sai số xác lập TB [°] | 0.658 ± — | 1.08 ± 0.097 | -38.8 | — | — | — | HAC |
| Sai số xác lập xấu nhất [°] | 2.04 ± — | 3.09 ± 1.4 | -34.1 | — | — | — | HAC |
| Thời gian xác lập TB [s] | 7.78 ± — | 7.45 ± 0.51 | 4.37 | — | — | — | Fuzzy |
| Số lần không vào băng | 4 ± — | 9 ± 1 | -55.6 | — | — | — | HAC |
| Vọt lố TB [%] | 0.0231 ± — | 0.0461 ± 0.046 | -50 | — | — | — | HAC |
| RMS PWM tổng [PWM] | 114 ± — | 119 ± 2.8 | -3.96 | — | — | — | HAC |
| RMS PWM phản hồi [PWM] | 70.4 ± — | 73.2 ± 10 | -3.79 | — | — | — | HAC |
| Biến thiên PWM [PWM/s] | 121 ± — | 77.4 ± 9.2 | 56.4 | — | — | — | Fuzzy |
| Tỉ lệ bão hoà [%] | 0 ± — | 0 ± 0 | — | — | — | — | = |
| Khối luật 5 khớp TB [µs] | 1.26 ± — | 178 ± 0.83 | -99.3 | — | — | — | HAC |
| Khối luật p99 [µs] | 7.71 ± — | 310 ± 8.4 | -97.5 | — | — | — | HAC |
| Chu kỳ tính TB [µs] | 26.6 ± — | 203 ± 1.1 | -86.9 | — | — | — | HAC |
| Chu kỳ tính p99 [µs] | 74.9 ± — | 363 ± 11 | -79.4 | — | — | — | HAC |
| CPU tiến trình [% 1 lõi] | 6.09 ± — | 13 ± 0.06 | -53.1 | — | — | — | HAC |
...
|---|---|---|---|
| Khối luật, 5 khớp [µs] | 1.26 | 178 | **141×** |
| Khối luật, 1 khớp [µs] | 0.252 | 35.6 | **141×** |
| Chu kỳ tính [µs] | 26.6 | 203 | **7.63×** |
| Chu kỳ tính / ngân sách chu kỳ [%] | 1.06 | 8.11 | **7.63×** |
| Khối luật / ngân sách chu kỳ [%] | 0.0504 | 7.13 | **141×** |
...
|---|---|---|---|---|
| waist | 0.243 / 0.699 | 0.195 / 0.563 | 7.21 / 8.18 | 28.6 / 27.6 |
| shoulder | 0.907 / 1.24 | 1.09 / 1.43 | 7.36 / 7.17 | 106 / 102 |
| elbow | 0.501 / 0.747 | 0.593 / 0.878 | 7.12 / 7.34 | 58.5 / 68 |
| wrist_angle | 0.331 / 0.823 | 0.462 / 1.24 | 9.27 / 6.66 | 39 / 46.4 |
| wrist_rotate | 0.00279 / 0.0185 | — / — | — / — | 0.324 / 1.27 |
