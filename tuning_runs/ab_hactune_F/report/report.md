# So sánh HAC vs Fuzzy — `ab_hactune_F`
...
|---|---|---|---|---|---|---|---|
| RMSE bám [°] | 0.57 ± — | 0.967 ± 0.11 | -41.1 | — | — | — | HAC |
| Sai số bám lớn nhất [°] | 1.86 ± — | 4.58 ± 2.1 | -59.4 | — | — | — | HAC |
| Sai số xác lập TB [°] | 0.67 ± — | 1.08 ± 0.097 | -37.8 | — | — | — | HAC |
| Sai số xác lập xấu nhất [°] | 1.81 ± — | 3.09 ± 1.4 | -41.4 | — | — | — | HAC |
| Thời gian xác lập TB [s] | 7.98 ± — | 7.45 ± 0.51 | 7.12 | — | — | — | Fuzzy |
| Số lần không vào băng | 4 ± — | 9 ± 1 | -55.6 | — | — | — | HAC |
| Vọt lố TB [%] | 0 ± — | 0.0461 ± 0.046 | -100 | — | — | — | HAC |
| RMS PWM tổng [PWM] | 121 ± — | 119 ± 2.8 | 1.74 | — | — | — | Fuzzy |
| RMS PWM phản hồi [PWM] | 73.3 ± — | 73.2 ± 10 | 0.184 | — | — | — | Fuzzy |
| Biến thiên PWM [PWM/s] | 129 ± — | 77.4 ± 9.2 | 66.7 | — | — | — | Fuzzy |
| Tỉ lệ bão hoà [%] | 0 ± — | 0 ± 0 | — | — | — | — | = |
| Khối luật 5 khớp TB [µs] | 1.27 ± — | 178 ± 0.83 | -99.3 | — | — | — | HAC |
| Khối luật p99 [µs] | 7.17 ± — | 310 ± 8.4 | -97.7 | — | — | — | HAC |
| Chu kỳ tính TB [µs] | 26.3 ± — | 203 ± 1.1 | -87 | — | — | — | HAC |
| Chu kỳ tính p99 [µs] | 77.4 ± — | 363 ± 11 | -78.7 | — | — | — | HAC |
| CPU tiến trình [% 1 lõi] | 6.11 ± — | 13 ± 0.06 | -52.9 | — | — | — | HAC |
...
|---|---|---|---|
| Khối luật, 5 khớp [µs] | 1.27 | 178 | **141×** |
| Khối luật, 1 khớp [µs] | 0.253 | 35.6 | **141×** |
| Chu kỳ tính [µs] | 26.3 | 203 | **7.7×** |
| Chu kỳ tính / ngân sách chu kỳ [%] | 1.05 | 8.11 | **7.7×** |
| Khối luật / ngân sách chu kỳ [%] | 0.0506 | 7.13 | **141×** |
| CPU cả tiến trình [% 1 lõi] | 6.11 | 13 | **2.12×** |
...
|---|---|---|---|---|
| waist | 0.382 / 0.699 | 0.312 / 0.563 | 7.36 / 8.18 | 26.9 / 27.6 |
| shoulder | 0.812 / 1.24 | 0.988 / 1.43 | 7.32 / 7.17 | 114 / 102 |
| elbow | 0.476 / 0.747 | 0.578 / 0.878 | 7.1 / 7.34 | 66.8 / 68 |
| wrist_angle | 0.519 / 0.823 | 0.598 / 1.24 | 9.98 / 6.66 | 43.8 / 46.4 |
