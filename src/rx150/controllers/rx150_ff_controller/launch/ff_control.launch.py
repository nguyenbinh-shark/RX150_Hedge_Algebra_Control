...
# Copyright (c) hust
#
# Launch the Interbotix rx150 under xsarm_control and start the ff controller (fuzzy PD + vel/acc feedforward).
...
def generate_launch_description():
    ...
    # Action 2 — ff controller node (namespace 'rx150' -> relative topics become /rx150/...).
